...
def score_classifications(
    ...
    # Dynamic label handling based on classification mode
    if mode == "multiclass":
        labels = ["0", "1", "2"]  # 0=normal, 1=hatespeech, 2=offensive
        label_to_int = {"0": 0, "1": 1, "2": 2}
    else:  # binary
        labels = ["0", "1"]  # 0=normal, 1=toxic
...
def main():
    ...
    parser.add_argument(
        ...
        help="Classification mode: binary (normal vs toxic) or multiclass (normal vs hatespeech vs offensive)",
    )
